      ...
      <div className="relative flex flex-row items-center justify-center md:space-x-8 space-y-8 md:space-y-0">
        ...
        <div className="flex flex-col items-center space-y-4 md:space-y-6 group">
          <div className="relative">
            <div
              className={`w-16 h-16 md:w-20 md:h-20 bg-gradient-to-r from-emerald-500 to-emerald-400 rounded-full flex items-center justify-center transition-all duration-700 shadow-2xl ${
                isAnimating ? "animate-pulse scale-110 shadow-emerald-500/50" : "shadow-emerald-500/30"
              }`}
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
